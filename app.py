...
def connect_db():
    ...
    sql = sqlite3.connect('C:/Users/Char/PycharmProjects/WebAppFoodTrack/food_log.db')
    sql.row_factory = sqlite3.Row  # result dict instead of tuples
    return sql
    #check sqlite3 food_log.db
...
@app.route('/view/<date>', methods=['GET', 'POST'])  # date is 20180519
def view(date):
    db = get_db()
    ...
    log_cur = db.execute(
        ...
        [date])
    # joining log_date id with id
    log_results = log_cur.fetchall()

    #get the food totals for the day
    #creat totals dict
    totals = {}
    totals['protein'] = 0
